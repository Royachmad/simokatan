                  ...
                  <form action="#" id="form">                      
                    <input type="hidden" name="id_desa" />
                      ...
                      <div class="mb-2">
                        ...
                        <select class="form-control" id='id_kecamatan' name="id_kecamatan" data-live-search="true" required>
                      ...
                      <div class="mb-2">
                        ...
                        <input class="form-control" type="text" name="nama_desa" id="nama_desa" value="">
                      </div>
                    </form>
                  </div>
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-body">
            ...
            <table id="basic-desa" class="table table-striped table-bordered nowrap">
                <thead>
                  <tr>
                    <th style="text-align: center; width: 10%">No</th>
                    <th style="text-align: center; width: 30%">Kecamatan</th>
...
<script>
  ...
  $(document).ready(function() {
    ...
    table = $('#basic-desa').DataTable({
      ...
      "ajax": {
        "url": "<?php echo site_url('desa/ajax_list1') ?>",
        "type": "POST"
      },
  ...
  function edit_data(id) {
    ...
    $.ajax({
      url: "<?php echo site_url('desa/ajax_edit1/') ?>/" + id,
      type: "GET",
      dataType: "JSON",
      success: function(data) {
        ...
        $('.modal-title').text('Update Data Desa'); // Set title to Bootstrap modal title
  ...
  function save() {
    if (save_method == 'add') {
      url = "<?php echo site_url('desa/ajax_add1') ?>";
      ...
      url = "<?php echo site_url('desa/ajax_update1') ?>";
  ...
  function delete_data(id) {
    if (confirm('Apakah anda yakin akan menghapus data tersebut ?')) {
      ...
      $.ajax({
        url: "<?php echo site_url('desa/ajax_delete1') ?>/" + id,
        type: "POST",
        dataType: "JSON",
        success: function(data) {
