...
class M_master extends CI_Model
{
    public function __construct()
    {
      ...
      var $table = 'kecamatan';
      var $column_order = array('nama_kecamatan'); //set column field database for datatable orderable
      var $column_search = array('nama_kecamatan'); //set column field database for datatable searchable just firstname , lastname , address are searchable
      var $order = array('id_kecamatan' => 'desc'); // default order 
 ...
 function desa($kecamatanId){
    ...
    $kec= $this->db->get_where('desa',array('id_kecamatan'=>$kecamatanId));
