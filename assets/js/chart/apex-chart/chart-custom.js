...
var options2 = {
    ...
    series: [{
        data: [400, 430, 448, 470, 340, 80, 90, 100, 200, 300]
    }],
    xaxis: {
        categories: ['Padi', 'Jagung', 'Bawang Merah', 'Ubi Jalar', 'Kacang Tanah', 'Pakcoy/Sawi Daging', 'Cabe Merah', 'Buncis', 'Bayam', 'Terong'],
    },
    colors:[vihoAdminConfig.primary]
}
